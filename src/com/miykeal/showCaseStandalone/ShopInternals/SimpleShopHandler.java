...
public class SimpleShopHandler implements ShopHandler {
        ...
        private Shop[]          shops;   
	private ShopStorageHandler 		storage	= null;
...
//
	...
	/**
	 * @see com.miykeal.showCaseStandalone.interfaces.ShopHandler#setStorage(com.miykeal.showCaseStandalone.interfaces.ShopStorageHandler)
	 */
        @Override
	public void setStorage (ShopStorageHandler ss) throws IOException {
		this.storage	= ss;
		this.reload();
	}
	...
	@Override
	public int importStorage(ShopStorageHandler storage) throws IOException {
		int loaded = this.storage.importStroage(storage);
...
//                        throw new ShopNotFoundException();
	...
	/**
	 * @see com.miykeal.showCaseStandalone.interfaces.ShopHandler#addShop(com.miykeal.showCaseStandalone.Shops.Shop)
	 */
        @Override
	...
	/**
	 * @see com.miykeal.showCaseStandalone.interfaces.ShopHandler#removeShop(com.miykeal.showCaseStandalone.Shops.Shop)
	 */
        @Override
...
//                            	
            	...
            	double px	= p.getLocation().getChunk().getX();
            	double pz	= p.getLocation().getChunk().getZ();
            	World  pw	= p.getLocation().getChunk().getWorld();

...
public class ShowCaseStandalone extends JavaPlugin {
    ...
    private ShopStorageHandler			shopStorage	= null;
...
//        if (Properties.storageType.equalsIgnoreCase("ffss"))
...
//            Localization.init(Properties.localizationFileName);
        ...
        inventoryListener	= new ShowCaseStandaloneInventoryListener	(this);
     ...
     */
    public ShopStorageHandler getShopStorage(){
    ...
    public void loadSCSConfig(FileConfiguration config){
        ...
        Properties.stackToMaxAmount				= config.getBoolean("Display.UseMaxStackAmount");
    ...
    private class ShowCaseStandaloneServerListener implements Listener {
        ...
        public void onPluginEnable(PluginEnableEvent event) {
            ...
            if (name.equals("com.palmergames.bukkit.towny.Towny")) {
        		log(Level.INFO, "Hooked into Towny");
        		scs.townyListener	= new ShowCaseStandaloneTownyListener();
        	    scs.getServer().getPluginManager().registerEvents(townyListener, scs);
            }
        }
        ...
        public void onPluginDisable(PluginDisableEvent event) {
    		...
    		// Towny
            if (p.getClass().getName().equals("com.palmergames.bukkit.towny.Towny")) {
        		log(Level.INFO, "Un-hooked Towny");
        		scs.getServer().getPluginManager().registerEvents(townyListener, scs);
            }
        }
    }

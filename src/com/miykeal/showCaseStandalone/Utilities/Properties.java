...
public class Properties {
	...
	public static final String  seperator	= ";";
        public static final String[] defaultLocaleFiles = {"locale_EN.yml", "locale_DE.yml", "locale_ES.yml"};
